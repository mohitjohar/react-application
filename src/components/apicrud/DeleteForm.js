...
<input type="number" name="name" placeholder="Enter id" value={this.state.id} onChange={(e) => this.setState({ id: e.target.value })}/>
<button className="btn" type="submit">Delete Data</button>
</fieldset>
</form>
</>
